...
public class SettingsService
{
    ...
    private static readonly Cache<PropertyInfo, Type?> NullableCache = new Cache<PropertyInfo, Type?>(GetRealType);
        ...
        out object? value)
    {
        ...
        var propertyType = NullableCache[property];
    ...
    public IReadOnlyCollection<PropertyInfo> GetKeys<T>()
    {
